...
Human decision gates have no coordinator-imposed deadline, and the pipeline has no total-run timeout. Explicit role timeouts bound individual worker attempts only, allowing detached runs to remain available overnight or through multi-hour review/fix loops.
