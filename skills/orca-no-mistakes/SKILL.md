...
```json
{"runId":"<orca-run-id>","steps":["intent","rebase","review","test","document","lint"],"custodyNote":"...","attestation":{"version":"1.0.0","merkleRoot":"..."}}
```
