...
# ------------------------------------------------------------------------------
auto_fix:
  # Toggle for durable pipeline automatic repair attempts across stages (default: true).
  # Controls durable pipeline auto-fix only and does not enable the TUI-local responder.
  enabled: true
